...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('pathname', 'D:\\ardetector\\data\\ssc_other', 'Files to execute.')
...
flags.DEFINE_string('output_dir','D:\\ardetector\\data\\pred','Directory for predictions')
